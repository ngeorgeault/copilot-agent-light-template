...
## Vue d’ensemble
L’agent s’exécute dans **Microsoft 365 Copilot** / **Teams** (expérience Lite). Les réponses sont **génératives** et **ancrées** sur des sources M365 approuvées. Les actions sont exécutées via connecteurs contrôlés.
...
flowchart LR
  ...
  subgraph M365_Copilot_Runtime["M365 Copilot Runtime"]
    A --> I[Instructions\n(≤ 8k, concises)]
